...
**Creates k8s PersistentVolumeClaim**
...
Synopsis
--------
- Creates k8s PersistentVolumeClaim, which is a user's request for and claim to a persistent volume
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>Possible list elements are <code>ReadWriteOnce</code>, <code>ReadOnlyMany</code>, <code>ReadWriteMany</code></div>
                        <div>If <em>state=present</em>, at least 1 access_mode should be specified.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>Use to create or delete an object without providing a full resource definition.</div>
            ...
            <tr>
                ...
                <td>
                        <div>Determines if an object should be created, or deleted. When set to <code>present</code>, an object will be created, if it does not already exist. If set to <code>absent</code>, an existing object will be deleted. If set to <code>present</code>, an existing object will be patched, if its attributes differ from those specified as module params.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>storage_class_name</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>Name of the StorageClass required by the claim.</div>
                        <div>When both <em>selector</em> and <em>storage_class_name</em> are specified together, the requirements are <code>ANDed</code> together.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                ...
                <td>
                        <div>Describe the maximum amount of compute resources allowed.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                ...
                <td>
                        <div>Describes the minimum amount of compute resources required.</div>
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    <li><div style="color: blue"><b>Filesystem</b>&nbsp;&larr;</div></li>
                                    <li>Block</li>
                        </ul>
                </td>
                <td>
                        <div>Defines what type of volume is required by the claim.</div>
                        <div>A volume with <em>volume_mode=Filesystem</em> is mounted into Pods into a directory. If the volume is backed by a block device and the device is empty, Kubernetes creates a filesystem on the device before mounting it for the first time.</div>
                        <div>A volume with <em>volume_mode=Block</em>is used as a raw block device. Such volume is presented into a Pod as a block device, without any filesystem on it. This mode is useful to provide a Pod the fastest possible way to access a volume, without any filesystem layer between the Pod and the volume. On the other hand, the application running in the Pod must know how to handle a raw block device.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                ...
                <td>
                        <div>The binding reference to the PersistentVolume backing this claim.</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
...
.. seealso::
   ...
   `K8s PersistentVolumeClaim documentation <https://kubernetes.io/docs/concepts/storage/persistent-volumes/>`_
       Documentation on Persistent Volumes on kubernetes website
   `K8s PersistentVolumeClaim API reference <https://kubernetes.io/docs/reference/kubernetes-api/config-and-storage-resources/persistent-volume-claim-v1/>`_
       API reference for K8s PersistentVolumeClaim resource on kubernetes website
