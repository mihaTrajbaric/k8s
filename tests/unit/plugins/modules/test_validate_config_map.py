...
from ansible_collections.sodalite.k8s.plugins.modules.config_map import validate

from copy import deepcopy

config_map_valid_def = {
    "apiVersion": "v1",
    "kind": "ConfigMap",
    "metadata": {
        "name": 'foo',
...
def test_valid():
    module = MagicMock()
    test_def = deepcopy(config_map_valid_def)
...
def test_binray_data_string_byte_dict():
    module = MagicMock()
    test_def = deepcopy(config_map_valid_def)
